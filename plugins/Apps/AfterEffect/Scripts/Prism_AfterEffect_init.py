...
from Prism_AfterEffect_Functions import Prism_AfterEffect_Functions
from Prism_AfterEffect_Integration import Prism_AfterEffect_Integration


class Prism_Plugin_AfterEffect(
    Prism_AfterEffect_Variables,
    Prism_AfterEffect_externalAccess_Functions,
    Prism_AfterEffect_Functions,
    ...
    def __init__(self, core):
        ...
        Prism_AfterEffect_Functions.__init__(self, core, self)
