...
if __name__ == "__main__":
    ...
    if platform.system() == "Windows":
        home = getWindowsDocumentsPath()
    elif platform.system() == "Linux":
        home = os.path.join(os.environ["HOME"])
    elif platform.system() == "Darwin":
        home = os.path.join(os.environ["HOME"], "Library", "Preferences")

    path = os.path.join(home, "Prism2")
    setting_path = os.path.join(path, )
    print(path)
