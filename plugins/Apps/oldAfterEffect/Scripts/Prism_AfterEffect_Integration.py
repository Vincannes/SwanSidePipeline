...
class Prism_AfterEffect_Integration(object):
    def __init__(self, core, plugin):
        ...
        if platform.system() == "Windows":
            self.examplePath = (
                self.core.getWindowsDocumentsPath() + "\\AfterEffect\\2019"
            )
            ...
            self.examplePath = os.path.join("/home", userName, "AfterEffect", "2019")
            ...
            self.examplePath = (
                "/Users/%s/Library/Preferences/Autodesk/AfterEffect/2019" % userName
            )
    ...
    def getExecutable(self):
        execPath = ""
        if platform.system() == "Windows":
            defaultpath = os.path.join(self.getAfterEffectPath(), "AfterEffect.exe")
    ...
    def addIntegration(self, installPath):
        try:
            ...
            msgStr = (
                "Errors occurred during the installation of the AfterEffect integration.\nThe installation is possibly incomplete.\n\n%s\n%s\n%s"
    ...
    def removeIntegration(self, installPath):
        try:
            ...
            msgStr = (
                "Errors occurred during the removal of the AfterEffect integration.\n\n%s\n%s\n%s"
                % (str(e), exc_type, exc_tb.tb_lineno)
            )
            msgStr += "\n\nRunning this application as administrator could solve this problem eventually."
